...
build-windows: frontend-build embed-frontend
	...
	GOOS=windows GOARCH=amd64 $(GOBUILD) -ldflags "-H windowsgui $(VERSION) -X main.BuildTime=$(BUILD_TIME)" -tags embed_frontend -o $(BINARY_DIR)/windows/$(BINARY_NAME).exe ./cmd/ms
